...
import fusion_net.utils.encoder as encoder
import fusion_net.utils.decoder as decoder
...
class FusionNetModel(pl.LightningModule):
    '''
    Image radar fusion
    ...
    def __init__(self, cfg):
        ...
        n_resolution_decoder = cfg.MODEL.DEPTH.DECODER.RESOLUTION
        ...
        min_predict_depth = cfg.MODEL.DEPTH.MIN_DEPTH_EVALUATION,
        max_predict_depth = cfg.MODEL.DEPTH.MAX_DEPTH_EVALUATION,
        ...
        elif fusion_type == 'weight_and_project':           # TRUE 
            n_filters_encoder = n_filters_encoder_image
            latent_channels = n_filters_encoder[-1]
        ...
        # Build encoder
        if 'fusionnet18' in encoder_type or 'resnet18' in encoder_type: # TRUE
            n_layer = 18
        ...
        if 'fusionnet18' in encoder_type or 'fusionnet34' in encoder_type: # TRUE
            self.encoder = encoder.FusionNetEncoder(
                n_layer=n_layer,
        ...
        if 'multiscale' in decoder_type:
            self.decoder = decoder.MultiScaleDecoder(

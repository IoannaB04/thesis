...
python fusion_net/train_fusionnet.py \
--train_image_path \
    expand_jbf/paths/nuscenes_train_image.txt \
--train_depth_path \
    expand_jbf/paths/nuscenes_train_depth_map.txt \
--train_response_path \
    expand_jbf/paths/nuscenes_train_confidence_map.txt \
--train_ground_truth_path \
    expand_jbf/paths/nuscenes_train_lidar.txt \
--val_image_path \
    expand_jbf/paths/nuscenes_validation_image.txt \
--val_depth_path \
    expand_jbf/paths/nuscenes_validation_depth_map.txt \
--val_response_path \
    expand_jbf/paths/nuscenes_validation_confidence_map.txt \
--val_ground_truth_path \
    expand_jbf/paths/nuscenes_validation_lidar.txt \
--batch_size 8 \
--n_height 224 \
--n_width 224 \
...
--checkpoint_dirpath \
    /media/bourcha/F6C0FAB4C0FA79E7/bourcha/trained_fusionnet/fus18project6ms1bn_16x448x448_lr0-1e3_100_aug0-100_100_bri080-120_con080-120_sat080-120_hflip_l1_sm000_wd000_outrm7-150_dilate0_min1max100_lidar_loss200_interp_with_reproj \
